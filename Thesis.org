...
** Limitations
- Cannot check if Item really emits something
- Currently, no error handling by the bind (needs to be done within the cont)
- runner cannot be further composed
- Just primitives
- necessarily more overhead than just an if
